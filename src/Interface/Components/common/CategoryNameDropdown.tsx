...
interface CategoryNameDropdownProps {
...
function CategoryNameDropdown({ onSelect, selectedCategoryName, onCategoriesLoaded, className = "" }: CategoryNameDropdownProps) {
	...
	const selectValue = useMemo(() => selectedCategoryName || "", [selectedCategoryName]);
...
export default CategoryNameDropdown; 